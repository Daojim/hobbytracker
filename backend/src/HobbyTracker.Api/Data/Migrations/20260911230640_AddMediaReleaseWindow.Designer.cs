...
namespace HobbyTracker.Api.Data.Migrations
{
    ...
    [Migration("20260911230640_AddMediaReleaseWindow")]
    partial class AddMediaReleaseWindow
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HobbyTracker.Api.Domain.Media", b =>
                {
                    ...
                    b.Property<DateOnly?>("ReleaseEnd")
                        .HasColumnType("date")
                        .HasColumnName("release_end");

                    b.Property<string>("ReleasePrecision")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                    ...
                    b.HasIndex("ReleaseEnd")
                        .HasDatabaseName("ix_media_release_end");
